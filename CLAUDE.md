...
**IMPORTANT: After conversation compaction, ALWAYS read this file (CLAUDE.md) and PLAN.md to restore context, then IMMEDIATELY continue working. Do not summarize or wait for input.**

...
fun mk_JE_Name (s, tc_opt, src_id_opt, ty) =
  list_mk_comb(JE_Name_tm, [fromMLstring s,
                           ...
                           src_id_opt, ty])
fun mk_JE_Attribute (e, attr, tc_opt, base_ty_name_opt, src_id_opt, ty) =
...
fun d_json_expr () : term decoder = achoose "expr" [
  ...
  (* Attribute - extract result typeclass, base_type_name, source_id, and type *)
  ...
  check_ast_type "Attribute" $
    JSONDecode.map (fn (((((e, attr), tc_opt), base_ty_name_opt), src_id_opt), ty) => mk_JE_Attribute(e, attr, tc_opt, base_ty_name_opt, src_id_opt, ty)) $
    tuple2 (tuple2 (tuple2 (tuple2 (tuple2 (field "value" (delay d_json_expr), field "attr" string),

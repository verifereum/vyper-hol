(* Exact pinned-Python bytecode check for the larger block environment fixture. *)

Theory evalCompilerBytecodeBuiltinsEnvBlock
...
Theorem env_block_matches_python_oracle:
  compile_vyper (K SOME) (o1_policy all_capabilities)
    env_block_program =
    SOME ^(evalCompilerBytecodeLib.read_hex_bytes "env_block.hex")
Proof
  EVAL_TAC
QED

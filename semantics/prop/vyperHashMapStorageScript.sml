(*
 * vyperHashMapStorageScript.sml
 *
 * Low-level storage properties of Vyper HashMap values.
 * Defines hashmap_read/write over raw storage functions and proves
 * read-after-write properties at the storage level.
 *
 * See vyperHashMapScript.sml for the high-level state-based API.
 *)

Theory vyperHashMapStorage
Ancestors

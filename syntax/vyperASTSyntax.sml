structure vyperASTSyntax :> vyperASTSyntax = struct
  ...
  val ImmutableName_tm   = astk"ImmutableName"
  ...
  val ImmutableNameTarget_tm     = astk"ImmutableNameTarget"
  ...
  fun mk_ImmutableName s = mk_comb(ImmutableName_tm, fromMLstring s)

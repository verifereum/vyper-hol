structure vyperASTSyntax :> vyperASTSyntax = struct
  ...
  val BareGlobalName_tm   = astk"BareGlobalName"
  ...
  val BareGlobalNameTarget_tm     = astk"BareGlobalNameTarget"
  ...
  fun mk_FunctionDecl v m nr n a d t b = list_mk_comb(FunctionDecl_tm, [v,m,nr,n,a,d,t,b])
  ...
  fun mk_BareGlobalName (ty,s) = list_mk_comb(BareGlobalName_tm, [ty, fromMLstring s])
  ...
  fun mk_AbiDecode (ty,t,bytes) = list_mk_comb(TypeBuiltin_tm, [
    ty, AbiDecode_tm, t, mk_list([bytes], expr_ty)])
  fun mk_AbiEncode (ty,t,v) = list_mk_comb(TypeBuiltin_tm, [
    ty, AbiEncode_tm, t, mk_list([v], expr_ty)])
  ...
  fun mk_Isqrt (ty,e) = mk_Builtin ty Isqrt_tm (mk_list([e], expr_ty))

(*
 * Stack Order Analysis — Definitions
 *
 ...
 *
 * From livenessDefs:
 *   live_vars_at         — query liveness at instruction index
 *   input_vars_from      — live vars entering target from source (PHI-aware)
 *
 * From cfgDefs:
 *   cfg_succs_of         — successor labels
 *   cfg_preds_of         — predecessor labels
 *   cfg_analyze          — run CFG analysis
 *
 * From venomInst:
 *   operand, instruction, basic_block, ir_function
 *   is_terminator, lookup_block, ASSIGN, PHI
 *)

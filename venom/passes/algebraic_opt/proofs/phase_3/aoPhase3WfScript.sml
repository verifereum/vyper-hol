 ...
 *
 * Helper:
 *   ao_transform_inst structural properties (ne, term, non_term, phi, non_phi)
 *   ao_transform_block_bb_wf, ao_transform_block_bb_succs
 *)

Theory aoPhase3Wf
Ancestors
  algebraicOptDefs aoPeepholeSim aoPhase1Wf aoPhase3Ids
...
(* ===== ao_transform_inst: non-terminator / non-PHI ===== *)

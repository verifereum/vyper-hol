...
Proof
(* MERGE NOTE: eval-phis branch previously used a short case split proof here.
   Chose origin/main's full induction proof because it handles transformed PHI
   step behavior explicitly. If this fails, revisit eval_phis semantics for
   transform_block/step_inst interaction. *)
  rpt gen_tac >> strip_tac >>

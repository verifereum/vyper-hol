...
Theory rtaBlockProof
Ancestors
  rtaHelpers rtaDefs stateEquiv venomExecProps venomExecSemantics venomInst venomState list
...
Proof
  ...
  drule_all rtaHelpersTheory.transform_block_insts_EL_transformed >>

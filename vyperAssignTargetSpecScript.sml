...
Proof
  ...
  (strip_tac >>
   ...
   gvs[return_def, raise_def]) >-
  (* TupleTargetV with TupleV - TODO: do-block unfolding issue *)
  cheat >-
  (* Other TupleTargetV cases - all vacuously true (raise) *)
  ...
  (* assign_targets cons case - TODO: needs both IHs chained *)
  cheat >-
